  ...
  <main>
    ...
    <article>
      ...
      <p>
        ...
        mettra au travail cette dynamique au sein de votre famille. Chacun pourra s’y
        exprimer, dans sa souffrance, dans ses besoins et ses souhaits aussi. Tout en
        amenant une nouvelle grille de lecture du problème, ce sera l'occasion pour chacun
        et tous ensemble de vivre une expérience relationnelle différente, progressivement
        plus claire, et dégagée, à terme, d’un symptôme qui n’a plus lieu d’être.
      </p>
      <p>
        Je vous accompagnerai dans ce voyage pour qu’ensemble, vous puissiez trouver vos
        propres solutions, celles qui vous ressemblent.
      </p>
      <p>
        Un
