  ...
  <main>
    ...
    <article>
      ...
      <ul class="bord">
        ...
        <li>
          Si vous sentez que vous avez du mal à vous habiter, à accéder à vos
          ressentis et donc à votre corps….
        </li>
        <li>
          Ou qu’il vous joue des tours d’une façon ou d’une autre (maladie,
      ...
      <section v-if="isMoreInfo">
        ...
        <p>
          ...
          dans l’inconscient et enregistrés dans le corps, formant une véritable
          cuirasse.
        </p>
        <p>
          Les blocages corporels inconscients (tensions musculaires chroniques,
          zones douloureuses, verrouillage des articulations, altération de la
          respiration, …) ne sont ni plus ni moins qu’un témoignage de
        ...
        <p>
          Les pratiques que je suis amenée à vous proposer seront variées et
          adaptées aux besoins de chacun(e).
        </p>
        <p>
          Il peut s’agir d’exercices de relaxation, de respiration, de postures
          ou de toucher du corps par exemple, ce toucher thérapeutique si
          précieux car il vient en point d’appui pour permettre à la personne de
          se connecter à elle-même, en premier lieu afin de retrouver une base
          de sécurité et bien au-delà, apaiser ses parts blessées.
        </p>
        <p>
          Bien sûr, il n'est pas toujours nécessaire de toucher directement au
          corps pour <span class="g">travailler avec le corps</span>. L'accueil
          des <span class="g">ressentis</span> et des
          ...
          l’expérience en cours afin de contacter votre réalité et votre vérité
          intérieure. <router-link to="/emdr" class="g">EMDR</router-link> ou <router-link to="/brainspotting" class="g">Brainspotting</router-link
          > entrent dans ce cadre-là, d’autres
          outils tels que TIPI ou NERTI également.
        </p>
        <p>
          Et, la cerise sur le gâteau, vous sera à coup sûr proposé en
          accompagnement des séances, en autonomie donc, quelques pratiques
          simples telles que la respiration consciente, la cohérence cardiaque,
          L’EFT…, participant toutes, de ce que j’ai envie d’appeler une
