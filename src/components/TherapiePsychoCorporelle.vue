...
C'est par et avec notre corps que nous sommes présents au monde et que nous l'habitons. C’est par notre corps que nous agissons, c’est dans et par notre corps que nous souffrons.
        ...
        <p>
          - Si vous vous posez des milliards de questions sur vous, votre vie et que le mental s’emballe… 
        </p>
        <p>
          - Si vous sentez que vous avez du mal à vous habiter, à accéder à vos ressentis et donc à votre corps….
        </p>
        <p>
          - Ou qu’il vous joue des tours d’une façon ou d’une autre (maladie, douleurs, tensions, angoisse, blocages…) 
        </p>
        <p>
        ...
        <p>
          Les blocages corporels inconscients (tensions musculaires chroniques, zones douloureuses, verrouillage des articulations, altération de la respiration, …) ne sont ni plus ni moins qu’un témoignage de l’histoire de la personne et des défenses qu’elle a édifiées pour s’adapter à son environnement. Autrement dit, ce qui n’a pu s’exprimer émotionnellement, s’imprime dans le corps ou finit par s’exprimer par des maux qu’il s’agisse de maux physiques, psychiques ou par un « mal à l’âme » indéfinissable.
        </p>
        <p>
          Comprenons que, dès notre conception, notre organisme enregistre chaque expérience vécue. Il garde, au plus profond de ses tissus, les traces des épreuves non digérées qui entravent son développement naturel et ce sous forme de tensions qui deviennent chroniques. Tout cela est inconscient. En dissolvant ces marques du passé, les schémas sclérosés peuvent alors se dénouer en douceur. Le corps s’en trouve apaisé et ressourcé.
        </p>
        <p>
          Permettre à la personne une réappropriation progressive de lui-même et de ses potentialités  afin de lui restituer sa pleine capacité à sentir, à éprouver, aimer et agir, telle paraît bien être la perspective thérapeutique première de cette reconnection intime Psyche-Soma.
        </p>
        <p>
          Les pratiques que je suis amenée à vous proposer seront variées et adaptées aux besoins de chacun(e).
        </p>
        <p>
