  ...
  <main>
    ...
    <article>
      <p>
        ...
        l’individu est influencé dans sa façon d’être, par le contexte dans lequel il vit
        ,ce qui est vécu par l'un a forcément des répercussions sur les autres. Toute la
      ...
      <p>
        ...
        membres de la famille pendant les séances. Car même si le problème trouve souvent
        ses sources dans des événements passés, elle part du postulat que seul le présent
        détient la solution.
      </p>
      <p>
        Pour le thérapeute systémicien, il est important de comprendre, en premier lieu,
        comment la souffrance s’est installée.
      </p>
      <p>
        Un symptôme peut servir à maintenir une situation en homéostasie, c’est-à-dire une
        stabilité du couple ou de la famille, comme, par exemple, l’échec scolaire d’un
        l’enfant ou tout comportement hors-norme qui peut monopoliser à ce point l’énergie
        parentale que les parents en oublient leur mésentente. Cet enfant est alors, en
      ...
      <p>
        ...
        pour mettre au travail tous les membres du système, réguler ses dysfonctionnements
        adaptatifs afin de susciter de nouvelles ressources et d’ouvrir de nouvelles
        perspectives.
      </p>
      <p>
        Favoriser les échanges, l’expression des émotions, accompagner l’évolution de la
        communication entre chacun des membres, donnera ainsi au couple ou à l’ensemble du
        groupe familial l’occasion de dépasser une situation de crise, d’expérimenter de
        nouvelles manières d’être, de ressentir, d’interagir différemment en somme, de
        façon à remettre en marche le processus évolutif et produire des communications
        allégées donc plus fluides.
      </p>
      <p>
        Mieux communiquer ensemble permettra également à chacun des membres, de se
        (ré)approprier une forme d’autonomie psychique, le sentiment d’exister sans être
