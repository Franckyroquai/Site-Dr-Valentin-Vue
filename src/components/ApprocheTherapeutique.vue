<template>
    <main>
        ...
        <p>
          Je me réfère aujourd’hui principalement aux avancées des neurosciences concernant les thérapies <span class="g">EMDR</span> et <span class="g">Brainspotting</span> principalement.
        </p>
        <p>
          Je m’appuie sur une approche humaniste avec l’assurance pour chacun de mes clients, petits et grands, en leur potentiel de croissance, de créativité, de réalisation. C’est dans ce cadre-là que j’intègre la <span class="g">dimension psychocorporelle</span> de la personne, son vécu émotionnel, ses ressentis.
        </p>
        <p>
          <span class="g">La thérapie systémique</span> s'inscrit dans une démarche globale qui consiste à décrypter les interactions verbales et émotionnelles au sein d’un groupe pour débusquer les blocages enfouis et retisser les liens endommagés. C’est l’accompagnement que je propose aux   couples ou aux familles qui viennent vers moi.  
        </p>
        <p>
