    ...
    <article>
      ...
      <section v-if="isMoreInfo">
        ...
        <article class="bg1">
          ...
          <p>
            Cette stimulation bilatérale alternée restructure en effet
            l’information traumatique dans le cortex et non plus dans le cerveau
            limbique (lié aux émotions), permettant ainsi de diminuer la charge
        ...
        <ul class="bg1">
          <li>
            Construire une relation thérapeutique de confiance avec son
            praticien.
          </li>
          <li>
            Identifier avec lui une problématique actuelle susceptible d’être
            traitée en <span class="i">EMDR</span>, puis les souvenirs
            traumatiques à l’origine de ces difficultés.
          </li>
          <li>
            Et enfin de mettre en place des outils psychocorporels de
            stabilisation émotionnelle qui peuvent être utilisés en cours de
            séance mais aussi en pratique autonome entre les séances.
          </li>
        </ul>
        <br />
        <article class="bg1">
          ...
          <p>
            ...
            génère plus de perturbations mais soit mis à distance, « effacé »,
            ou qu’il ait perdu sa vivacité. Ensuite, toujours avec des
            stimulations bilatérales alternées rapides, il aide le patient à
          ...
          <p>
            ...
            depuis, des équipes de volontaires formés à l’EMDR sont envoyées sur
            les lieux de catastrophes. On l’a beaucoup utilisé depuis les
