...
export default {
  ...
  le nom du composant
  dans le html du parent il se "source" de la maniere suivante : <register-component>
  dans le scripting (JS) du parent il se declare avec RegisterComponent et doit etre importé
  */
  props: {
